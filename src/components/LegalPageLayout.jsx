...
export default function LegalPageLayout({ title, description, children }) {
  return (
    <main className="hero-surface relative isolate min-h-screen overflow-hidden bg-[#212121] px-4 py-8 text-gray-200 sm:px-6 lg:px-8">
      <div className="relative z-10 mx-auto max-w-3xl">
        <header className="flex items-center justify-between gap-6 border-b border-white/10 pb-6">
          ...
          <a
            className="text-sm font-semibold text-[#FFB800] transition-colors hover:text-[#E6A600] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#FFB800]"
            href="#/"
          >
        ...
        <footer className="border-t border-white/10 py-8 text-sm leading-relaxed text-gray-400">
